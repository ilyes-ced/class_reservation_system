        ...
        <div class="col">
          <div class="form-group">
            <div class="input-group">
              ...
              <input style='width:40%;margin-right: 10px;' name='this_date' type="date" value='<?php echo $date1; ?>' class="date form-control date-input" id="pure-date" aria-describedby="date-design-prepend">
