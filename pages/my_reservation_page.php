        ...
        window.onload = function() {
          ...
          $('#today_container').on('click', function() {
            ...
            for (let i = 0; i <= 6; i++) {
              ...
              document.getElementById('d' + i).innerHTML = date3.toLocaleString('en-us', {
                  weekday: 'short'
                }) + '<br/>' + ('0' + date3.getDate()).slice(-2) + '-' +
                ('0' + (date3.getMonth() + 1)).slice(-2) + '-' +
                date3.getFullYear();
          ...
          $('#add_week_container').on('click', function() {
            ...
            for (let i = 0; i <= 6; i++) {
              ...
              date = addDays(date, 1);
              document.getElementById('d' + i).innerHTML = date.toLocaleString('en-us', {
                  weekday: 'short'
                }) + '<br/>' + ('0' + dd.getDate()).slice(-2) + '-' +
