...
*/
  ...
  /*
  $sq[]="insert into rooms(room,indexes) values('AMPHI ','1')";
  $sq[]="insert into rooms(room,indexes) values('AMPHI ','2')";
  $sq[]="insert into rooms(room,indexes) values('AMPHI ','3')";
  $sq2[]="insert into rooms(room,indexes) values('TD ','1')";
  $sq2[]="insert into rooms(room,indexes) values('TD ','2')";
  $sq2[]="insert into rooms(room,indexes) values('TD ','3')";
  $sq3[]="insert into rooms(room,indexes) values('TP ','1')";
  $sq3[]="insert into rooms(room,indexes) values('TP ','2')";
  $sq3[]="insert into rooms(room,indexes) values('TP ','3')";
    ...
    $req = $bdd->query('INSERT INTO rooms(room,indexes) VALUES("AMPHI ","1")');
    $req = $bdd->query('INSERT INTO rooms(room,indexes) VALUES("AMPHI ","2")');
    $req = $bdd->query('INSERT INTO rooms(room,indexes) VALUES("AMPHI ","3")');
    $req = $bdd->query('INSERT INTO rooms(room,indexes) VALUES("TD ","1")');
    $req = $bdd->query('INSERT INTO rooms(room,indexes) VALUES("TD ","2")');
    $req = $bdd->query('INSERT INTO rooms(room,indexes) VALUES("TD ","3")');
    $req = $bdd->query('INSERT INTO rooms(room,indexes) VALUES("TP ","1")');
    $req = $bdd->query('INSERT INTO rooms(room,indexes) VALUES("TP ","2")');
    $req = $bdd->query('INSERT INTO rooms(room,indexes) VALUES("TP ","3")');
...
if(isset($_POST['teachers'])){
  ...
  if(isset($_POST['grade'])){$bdd->query("UPDATE users SET grade='".$_POST['grade']."' WHERE username='".$_POST['teachers']."' ");}
  if(isset($_POST['dep'])){$bdd->query("UPDATE users SET departement='".$_POST['dep']."' WHERE username='".$_POST['teachers']."' ");}
  if(isset($_POST['type_pers'])){$bdd->query("UPDATE users SET type='".$_POST['type_pers']."' WHERE username='".$_POST['teachers']."' ");}
}
...
if(isset($_POST['submit2'])){
  ...
  }else{$col=str_pad(dechex(mt_rand(0, 0xFFFFFF)), 6, '0', STR_PAD_LEFT);
