...
if($_COOKIE['admin']==null){header("Location: login");}
...
if(isset($_POST['added'])){
  ...
  if($result['indexes']==$_POST['added']){$co++;}
  }
  ...
  }else{$error='do not add duplicate rooms';}
...
if(isset($_POST['added2'])){
  ...
  while($result=$req->fetch()){
  if($result['indexes']==$_POST['added2']){$co++;}
  }
...
if(isset($_POST['added3'])){
  ...
  while($result=$req->fetch()){
  if($result['indexes']==$_POST['added3']){$co++;}
  }
