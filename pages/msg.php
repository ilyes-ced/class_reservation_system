...
if(isset($_POST['refuse'])){
  $req = $bdd->query('DELETE  FROM  contact WHERE id='.$_POST['refuse']);
  unset($_POST['refuse']);
}
     */   
...
if(isset($_POST['accept'])){
  ...
  $req2 = $bdd->query('SELECT * FROM contact where id='.$_POST['accept']);
  while($gg=$req2->fetch()){
    $id=$gg['id'];
    $cell=$gg['cell'];
    $sender=$gg['sender'];
...
$req = $bdd->query('DELETE  FROM  contact WHERE id='.$_POST['accept']);
